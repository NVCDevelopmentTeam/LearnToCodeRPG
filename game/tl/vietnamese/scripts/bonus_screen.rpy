...
translate vietnamese strings:
    ...
    new "{icon=icon-music} Trò chơi nhịp điệu"
    ...
    new "{icon=icon-award} Số thành tựu đã mở khóa: [num_achievements] / [total_num_achievements]"

    # game/scripts/bonus_screen.rpy:60
    old "{icon=icon-twitter} Tweet it when you've unlocked all of the achievements!"
    new "{icon=icon-twitter} Hãy chia sẻ lên Twitter khi bạn đã mở khóa được tất cả thành tựu nhé!"

    # game/scripts/bonus_screen.rpy:82
    old "{icon=icon-twitter} Tweet this"
    new "{icon=icon-twitter} Đăng Tweet này"
