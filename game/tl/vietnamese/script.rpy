...
translate vietnamese strings:
    ...
    new "We'll start whenever you're ready."

    # game/script.rpy:17
    old "Guess I have no other options. Let's start!"
    new "Guess I have no other options. Let's start!"

    # game/script.rpy:28
    old "How do you prove that P = NP in one sentence?"
    new "How do you prove that P = NP in one sentence?"
    ...
    new "In Python, what is a generator?"

    # game/script.rpy:62
    old "How do you explain how the Internet works to a five year old?"
    new "How do you explain how the Internet works to a five year old?"
    ...
    new "What is your name? {color=[red]}*{/color} (Type your name and hit Enter. This name will be used throughout the game and you cannot change it unless you start a new game.)"
    ...
    new "How did you hear about this opportunity?"
    ...
    new "What was your experience like when you first joined?"

    # game/script.rpy:1552
    old "How was your transition from college to work?"
    new "How was your transition from college to work?"

    # game/script.rpy:1552
    old "What is our team like?"
    new "What is our team like?"

    # game/script.rpy:1594
    old "Let's double-check the code!"
    new "Let's double-check the code!"

    # game/script.rpy:1594
    old "Let's triple-check the code!"
    new "Let's triple-check the code!"

    # game/script.rpy:1594
    old "Let's quadruple-check the code!"
    new "Let's quadruple-check the code!"

    # game/script.rpy:1594
    old "Looks good to go!"
    new "Looks good to go!"

    # game/script.rpy:1645
    old "{color=[red]}{icon=icon-alert-triangle} Attention{/color}"
    new "{color=[red]}{icon=icon-alert-triangle} Attention{/color}"
    ...
    new "{bt}{size=48}{color=[white]}{i}Well, that's another chapter that we will bring to you in the future!{/i}{/color}{/size}{/bt}"
